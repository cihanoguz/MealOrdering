...
namespace MealOrdering.Server.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        {
            Filter.CreateDateLast = Filter.CreateDateLast.AddDays(1);
            Filter.CreateDateFirst = !Filter.CreateDateFirst.HasValue ? Filter.CreateDateFirst : Filter.CreateDateFirst.Value.AddDays(-1) ;
            return new ServiceResponse<List<OrderDTO>>()
            {
